        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="home.php" style="font-weight: 500;">HOME <span
...
">
        ...
        <h3 style="margin-bottom: 60px;">Service a refrigerator, washing machine or air conditioner. Use the fix  app to book a service mechanic now or set an appointment for upto 48 hours.</h3>
