...
background-color:   #ffffff;">
    ...
    <div style="background-color:#282a36;color:#ffffff" class="jumbotron jumbotron-fluid">
        <div class="container">
            <h1 class="display-4"><P><p>Fix Home Appliances Easily</p></P></h1>
            <p class="lead">Home/Fix Home Appliances Easily</p>
        </div>
    </div>
...
">
        ...
        <h3 style="margin-bottom: 60px;">Service a refrigerator, washing machine or air conditioner. Use the Jackworks  app to book a service mechanic now or set an appointment for upto 48 hours.</h3>

        <div class="col-md-4">
            <img src="./html/Images/AIRCONDITIONERSERVICES.jpg"
                alt="Girl in a jacket" width="250" height="200">
            <h2>Air Conditioner Servicing</h2>
        </div>
        <div class="col-md-4">
            <img src="./html/Images/RefrigeratorServiceman.jpg" alt="Girl in a jacket"
                width="250" height="200">
            <h2>Refrigerator Servicing</h2>

        </div>
        <div class="col-md-3.5 ">
            <img src="./html/Images/HomeApplianceRepair.jpg"alt="Girl in a jacket" width="300" height="200">
            <h2>Washing Machine Servicing</h2>
    ...
    <div class="fusion-column-wrapper"
        ...
        <div class="fusion-separator fusion-full-width-sep sep-single"
            style="border-color:#e0dede;border-top-width:1px;margin-left: auto;margin-right: auto;"></div>
        <div class="fusion-text">
            <center><button class="btn btn-primary btn-lg"><a style=" color: white; " href="Booknow.php">Booknow</button></a></center> <br>
