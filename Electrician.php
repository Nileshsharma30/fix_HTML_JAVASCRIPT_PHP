...
<body style="background-color:   #ffffff;">
    ...
    <div style="background-color:#282a36;color:#ffffff" class="jumbotron jumbotron-fluid">
        <div class="container">
            <h3 class="display-4" style=" font-size: 56px;"> Get Instant Access Electricians Near You</h3>
...
">
        ...
        <h3 style="
        margin-bottom: 60px;
    ">Finish those small jobs that you have been waiting to do now. Use the fix app to book an electrician now or
            set an appointment for upto 48 hours.</h3>

        <div class="col-md-3">
            <img src="./html/Images/Electricians/fudein.jpg" alt="Girl in a jacket" width="250" height="200">
            <h2>Fix a switch, meter or fuse</h2>
        </div>
        <div class="col-md-3">
            <img src="./html/Images/Electricians/Regulator.jpg" alt="Girl in a jacket" width="250" height="200">
            <h2>Fix a Ceiling Fan or it’s Regulator</h2>

        </div>
        <div class="col-md-3 ">
            <img src="./html/Images/Electricians/lights.jpg" alt="Girl in a jacket" width="250" height="200">
            <h2>Fit new lights</h2>

        </div>
        <div class="col-md-3">
            <img src="./html/Images/Electricians/wirings.jpg" alt="Girl in a jacket" width="250" height="200">
            <h2>Install new or repair wirings</h2>
        </div>
    </div>
    <br><br><br>
