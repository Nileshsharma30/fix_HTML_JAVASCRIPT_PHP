...
?>    
    ...
    <body style=" background-color:   #ffffff;">
       ...
       <a class="" href="index.php">
        ...
        <div style="background-color:#282a36;color:#ffffff" class="jumbotron jumbotron-fluid">
            <div class="container">
                <h1 class="display-4">Get Instant Access To Plumbers Near You</h1>
    ...
    ">
            ...
            <h3 style=" margin-bottom: 60px;">Finish those small jobs that you have been waiting to do now. Use the fix app to book an plumber now or
                set an appointment for upto 48 hours.</h3>

            <div class="col-md-3">
                <img src="./html/Images/Plumber/fixaleakytap.jpg"
                    alt="Girl in a jacket" width="250" height="200">
                <h2>Fix a leaky tap or pipe</h2>
            </div>
            <div class="col-md-3">
                <img src="./html/Images/Plumber/sink.jpg" alt="Girl in a jacket"
                    width="250" height="200">
                <h2>Unclog a washbasin, sink or toilet</h2>

            </div>
            <div class="col-md-3 ">
                <img src="./html/Images/Plumber/bathroom.jpg"
                    alt="Girl in a jacket" width="250" height="200">
                <h2>Get your bathroom fittings done</h2>

            </div>
            <div class="col-md-3">
                <img src="./html/Images/Plumber/flushtank.jpg" alt="Girl in a jacket"
                    width="250" height="200">
                <h2>Install a flush tank or replace an old one </h2>
            </div>
        </div>
        <br><br><br>
